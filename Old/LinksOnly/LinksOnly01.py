...
#np.savetxt('group-N1-headed_NY.csv', xhist.T, delimiter = ',', fmt = '%6f')
#np.savetxt('group-N2-headed_NY.csv', xhist.T, delimiter = ',', fmt = '%6f')
#np.savetxt('lot-N2-headed_NY.csv', xhist.T, delimiter = ',', fmt = '%6f')
#np.savetxt('group_aberrant.csv', xhist.T, delimiter = ',', fmt = '%6f')

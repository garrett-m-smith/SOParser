...
plt.title("Links and features: dashed = 'sailboats'")
#plt.xlabel('Time')
...
plt.plot(soln_cabins[:,3], soln_cabins[:,-1], label='Cabins')
plt.plot(soln_sailboats[:,3], soln_sailboats[:,-1], label='Sailboats')
plt.title('Verb feature space')
plt.xlabel('Boat feature (no boat = 0, boat = 1)')
plt.ylabel('Singular (0), plural (1)')
plt.legend()
#plt.show()
plt.savefig('VerbFeatureSpace.pdf', bbox_inches='tight')
